...
const AppInfo = ({ isMobileScreen, showHideSideMenu }) => {
  const [shouldShowHamburgerButton, setShouldShowHamburgerButton] =
    useState(true);
    ...
    <section className="app-info">
      <div className="app-info__content container">
        <div className="app-info__container">
          <h1 className="app-info__title">Product FeedBack Tool</h1>

          <p className="app-info__sub-heading">Feedback Board</p>
        </div>
